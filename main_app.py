...
st.set_page_config(page_title="SMS Spam Detection System using NLP", page_icon="..\sms-spam_classifier-Debleena-main\page_icon.png")
...
st.markdown("""
    ---  
    Developed by **Debleena Maity** | [GitHub](https://github.com/Debleena2102)
""")
